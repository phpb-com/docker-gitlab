...
# quay.io/gotfix/gitlab:9.0.0-rc7

> Alternatively image is available from docker hub `gotfix/gitlab:9.0.0-rc7`
...
```bash
docker pull quay.io/gotfix/gitlab:9.0.0-rc7
```
...
docker run --name gitlab -d [OPTIONS] \
    quay.io/gotfix/gitlab:9.0.0-rc7 app:sanitize
```
...
```bash
docker run --name gitlab -it --rm [OPTIONS] \
    quay.io/gotfix/gitlab:9.0.0-rc7 app:rake gitlab:backup:create
```
...
```bash
docker run --name gitlab -it --rm [OPTIONS] \
    quay.io/gotfix/gitlab:9.0.0-rc7 app:rake gitlab:backup:restore
```
...
```bash
docker run --name gitlab -it --rm [OPTIONS] \
    quay.io/gotfix/gitlab:9.0.0-rc7 app:rake gitlab:backup:restore BACKUP=1417624827
```
...
```bash
docker run --name gitlab -it --rm [OPTIONS] \
    quay.io/gotfix/gitlab:9.0.0-rc7 app:rake gitlab:env:info
```
...
```bash
docker run --name gitlab -it --rm [OPTIONS] \
    quay.io/gotfix/gitlab:9.0.0-rc7 app:rake gitlab:import:repos
```
...
```bash
docker run --name gitlab -d [OPTIONS] quay.io/gotfix/gitlab:9.0.0-rc7
```
