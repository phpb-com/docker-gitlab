...
**9.3.9**
- gitlab: Gitlab CE 9.3.9

**9.3.8**
- gitlab: Gitlab CE 9.3.8
- Security update

**9.3.7**
- gitlab: Gitlab CE 9.3.7
- Security update

**9.3.6**
- gitlab: Gitlab CE 9.3.6
...
**9.2.6**
- gitlab: Gitlab CE 9.2.6

**9.2.5**
- gitlab: Gitlab CE 9.2.5

**9.2.4**
- gitlab: Gitlab CE 9.2.4

**9.2.3**
- gitlab: Gitlab CE 9.2.3

**9.2.2**
- gitlab: Gitlab CE 9.2.2

**9.2.1**
- gitlab: Gitlab CE 9.2.1

**9.2.0-1**
- gitlab: Gitlab CE 9.2.0
- Update gitlab-monitor to 1.7.0

**9.2.0**
- gitlab: Gitlab CE 9.2.0
- Gitaly is enabled by default, you can use `GITALY_ENABLED` parameter to disable it.
...
- Use latest redis-tools in the container from PPA chris-lea
- Improved GITLAB_SSH_MAXSTARTUPS default
- Other minor clean-ups and improvements

**9.1.1-2**
- gitlab: Gitlab CE 9.1.1
- Fix REDIS_URL creation
...
- Fixing incorrect handling of omniauth scope variables

**9.0.2-2**
- gitlab: Gitlab CE 9.0.2
- Fix gitlab-monitor config (workaround)
- Move main image to docker hub

**9.0.2-1**
- gitlab: Gitlab CE 9.0.2
- gitlab: Gitlab-shell 5.0.2
- Improve gitlab-monitor configuration, and sample prometheus.yml file
...
- Minor documentaion clean-u;

**8.17.3-5**
**8.17.3-4**
- gitlab: Gitlab CE v8.17.3
- Clean-up of documentation
- Migrate to quay.io from hub.docker.com
- Move from github to gotfix
